...
function finalPos(initialPos, probeInstruction){
    var COS = {'0': 1, '90': 0, '180': -1, '270': 0, '360': 1};
    var SIN = {'0': 0, '90': 1, '180': 0, '270': -1, '360': 0};
    ...
    var output = probeInstruction.split('').reduce((prev,curr) => {
        ...
        var cos = Math.abs(COS[prev[2]]);
        var sin = Math.abs(SIN[prev[2]]);
    ...
    var cos = Math.abs(COS[output[2]]);
    var sin = Math.abs((SIN[output[2]]);
